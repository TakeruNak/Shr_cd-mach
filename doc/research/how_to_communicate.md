...
excerpt: 情報伝達・コミュニケーションの設計指針(自分用メモ)
...
* **役割:** Graphical Image（図表・グラフ・写真）は，Statementを証明するための客観的証拠である．
...
> 常に「この情報を使って相手にどう動いてほしいか」という**Suggest（提案）**までを含める．
